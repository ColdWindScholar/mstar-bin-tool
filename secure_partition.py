...
# Alignment
os.system(f'{alignment} {INPUT_FILE_NAME}')

# Generate signature
os.system(f'{SubSecureInfoGen} {OUTPUT_SIGNATURE_FILE_NAME} {INPUT_FILE_NAME} {RSA_PRIVATE_KEY} {RSA_PUBLIC_KEY} {ENABLE_PARTIAL_AUTHENTICATION} {NUMBER_FOR_PARTIAL_AUTHENTICATION} {ENABLE_INTERLEAVE_MODE} {BLOCK_SIZE_FOR_INTERLEAVE} {DISPLAY_DEBUGGING_INFO} {TOOLS_DIR}')

print(f'{SubSecureInfoGen} {OUTPUT_SIGNATURE_FILE_NAME} {INPUT_FILE_NAME} {RSA_PRIVATE_KEY} {RSA_PUBLIC_KEY} {ENABLE_PARTIAL_AUTHENTICATION} {NUMBER_FOR_PARTIAL_AUTHENTICATION} {ENABLE_INTERLEAVE_MODE} {BLOCK_SIZE_FOR_INTERLEAVE} {DISPLAY_DEBUGGING_INFO} {TOOLS_DIR}')

# Crypt input image
os.system(f'{aescrypt2} 0 {INPUT_FILE_NAME} {OUTPUT_FILE_NAME} {AES_KEY}')
